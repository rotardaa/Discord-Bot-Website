...
<p>⊳ Every discord server can use the Sword Uptime for free, it is completely prohibited to sell or market for a fee.</p>
...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/1073902407802687538/vote">Sword</a> Uptime at certain intervals.</p>
</div>
    </div>
  );
}
